...
gcc -I modules tests/test_term_result.c modules/course.c modules/courseResult.c modules/termResult.c -o test_term_result.out
chmod +x test_term_result.out
./test_term_result.out
